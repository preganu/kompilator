  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_stringarr = 48,                        // stringarr
        S_statementlist = 49,                    // statementlist
        S_statement = 50,                        // statement
        S_expressionlist = 51,                   // expressionlist
        ...
        S_vardeclarationlist = 56,               // vardeclarationlist
        S_vardeclaration = 57,                   // vardeclaration
        S_parameterlist = 58,                    // parameterlist
        S_methoddeclarationlist = 59,            // methoddeclarationlist
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_LEFTM (std::string v)
      {
        return symbol_type (token::LEFTM, std::move (v));
      }
#else
      static
      symbol_type
      make_LEFTM (const std::string& v)
      {
        return symbol_type (token::LEFTM, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LEFTP (std::string v)
      {
        return symbol_type (token::LEFTP, std::move (v));
      }
#else
      static
      symbol_type
      make_LEFTP (const std::string& v)
      {
        return symbol_type (token::LEFTP, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LEFTB (std::string v)
      {
        return symbol_type (token::LEFTB, std::move (v));
      }
#else
      static
      symbol_type
      make_LEFTB (const std::string& v)
      {
        return symbol_type (token::LEFTB, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHTB (std::string v)
      {
        return symbol_type (token::RIGHTB, std::move (v));
      }
#else
      static
      symbol_type
      make_RIGHTB (const std::string& v)
      {
        return symbol_type (token::RIGHTB, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHTP (std::string v)
      {
        return symbol_type (token::RIGHTP, std::move (v));
      }
#else
      static
      symbol_type
      make_RIGHTP (const std::string& v)
      {
        return symbol_type (token::RIGHTP, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHTM (std::string v)
      {
        return symbol_type (token::RIGHTM, std::move (v));
      }
#else
      static
      symbol_type
      make_RIGHTM (const std::string& v)
      {
        return symbol_type (token::RIGHTM, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_INTT (std::string v)
      {
        return symbol_type (token::INTT, std::move (v));
      }
#else
      static
      symbol_type
      make_INTT (const std::string& v)
      {
        return symbol_type (token::INTT, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SEMIC (std::string v)
      {
        return symbol_type (token::SEMIC, std::move (v));
      }
#else
      static
      symbol_type
      make_SEMIC (const std::string& v)
      {
        return symbol_type (token::SEMIC, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MOREOP (std::string v)
      {
        return symbol_type (token::MOREOP, std::move (v));
      }
#else
      static
      symbol_type
      make_MOREOP (const std::string& v)
      {
        return symbol_type (token::MOREOP, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_EQIF (std::string v)
      {
        return symbol_type (token::EQIF, std::move (v));
      }
#else
      static
      symbol_type
      make_EQIF (const std::string& v)
      {
        return symbol_type (token::EQIF, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MINOP (std::string v)
      {
        return symbol_type (token::MINOP, std::move (v));
      }
#else
      static
      symbol_type
      make_MINOP (const std::string& v)
      {
        return symbol_type (token::MINOP, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_EXQL (std::string v)
      {
        return symbol_type (token::EXQL, std::move (v));
      }
#else
      static
      symbol_type
      make_EXQL (const std::string& v)
      {
        return symbol_type (token::EXQL, v);
      }
#endif
